  ...
  return (
    <div className="min-h-screen bg-[#181818] font-sans text-white">
      ...
      <section className="w-full flex justify-center pt-10 pb-16">
        <div className="max-w-5xl w-full bg-[#232323] border border-[#232323] rounded-2xl shadow-xl p-10 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            <span className="block text-sm text-[#ededed] mb-2">Welcome to YourBank</span>
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Where Banking Meets <span className="text-[#B6FF48]">Excellence!</span>
            </h1>
      ...
      <section className="w-full max-w-5xl mx-auto px-8 pb-16">
        ...
        <p className="text-[#ededed] mb-8">We envision to be a leader in the industry, driven by innovation, integrity, and inclusivity, creating a brighter financial future for individuals and businesses while making a strong commitment to customer satisfaction and community development.</p>
      ...
      <section className="w-full max-w-7xl mx-auto px-8 pb-16">
        ...
        <p className="text-[#ededed] mb-8">Stay updated with the latest happenings and exciting developments at YourBank through our press releases.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-[#232323] border border-[#232323] rounded-2xl p-6 shadow flex flex-col">
